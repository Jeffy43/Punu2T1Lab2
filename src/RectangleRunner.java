...
public class RectangleRunner {
    public static void main(String[] args) {
        ...
        System.out.println("Rectangle 1's Area: " + (int)rect1.calculateArea() + ", Box Volume: " + rect1.calculateBoxVolume(rect1Height));
        System.out.println("Rectangle 2's Area: " + (int)rect2.calculateArea() + ", Box Volume: " + rect2.calculateBoxVolume(rect2Height));
    }
}
